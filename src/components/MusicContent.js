...
export const content = <div align="center">
    <p>
        <iframe src="https://open.spotify.com/follow/1/?uri=spotify:artist:7KWo5lhqXiYmR8klsOGCOl&size=basic&theme=dark" width="200" height="25" scrolling="no" frameborder="0" style = {{border:"none", overflow:"hidden"}}  allowtransparency="true"></iframe>
    </p>
